...
<div class="col-md-4 col-sm-4 col-lg-2 mb-4 mb-lg-0">
        <div class="card text-black text-center">
            <a href="index.php?page=view&id=<?php echo $data['id']?>">
            <img src="assets/img/pdf.webp"
            class="card-img-top mt-4" alt="Pdfs" style='width: 60px'/>
        </a>
          <div class="card-body">
              <div class="p-3 mx-n3 mb-4">
              <a href="http://localhost/gateways/bts/index.php?page=view&id=<?php echo $data['id']?>">
               ...
               <button class='btn btn-secondary text-center'><a href="http://localhost/gateways/bts/index.php?page=view&id=<?php echo $data['id']?>">Read pdf</a></button>
            </div>      
          </div>
        </div>
 <?php }
  ...
  header('Location: http://localhost/gateways/bts/index.php?page=payment');
  ob_end_flush();
